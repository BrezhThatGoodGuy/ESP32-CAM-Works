...
// Clean up closed WebSocket clients
  ws.cleanupClients();
  
  // If at least one web browser is connected, capture and send frames
  if (ws.count() > 0) {
    ...
    // Send the JPEG frame to all connected WebSocket clients
